...
function CountDuty(CarStatus, CarFuel, CarYear, CarMonth, CarVolume, CarPrice) {
    ...
    if (CarStatus == 1) {
        if (CarAge < 3.0) {
            ...
            if (CarVolume <= 1000) {
                DutyPrice = CarVolume * 1.5;
            }
            else if (CarVolume > 1000 && CarVolume <= 1500) {
                DutyPrice = CarVolume * 1.7;
            }
            else if (CarVolume > 1500 && CarVolume <= 1800) {
                DutyPrice = CarVolume * 2.5;
            }
            else if (CarVolume > 1800 && CarVolume <= 2300) {
                DutyPrice = CarVolume * 2.7;
            }
            else if (CarVolume > 2300 && CarVolume <= 3000) {
                DutyPrice = CarVolume * 3;
            }
            else if (CarVolume > 3000) {
                DutyPrice = CarVolume * 3.6;
            }
        }
        else if (CarAge >= 5.0) {
            if (CarVolume <= 1000) {
                ...
                DutyPrice = CarVolume * 3.2;
            }
            else if (CarVolume > 1500 && CarVolume <= 1800) {
                DutyPrice = CarVolume * 3.5;
            }
            else if (CarVolume > 1800 && CarVolume <= 2300) {
                DutyPrice = CarVolume * 4.8;
            }
            else if (CarVolume > 2300 && CarVolume <= 3000) {
                DutyPrice = CarVolume * 5;
            }
            else if (CarVolume > 3000) {
                DutyPrice = CarVolume * 5.7;
            }
        }
    }
        ...
        if (CarAge < 3.0) {
            if (CarVolume <= 1000) {
                DutyPrice = (CarPrice * 0.3 < CarVolume * 1.2) ? (CarVolume * 1.2) : (CarPrice * 0.3);
            }
            else if (CarVolume > 1000 && CarVolume <= 1500) {
                DutyPrice = (CarPrice * 0.3 < CarVolume * 1.45) ? (CarVolume * 1.45) : (CarPrice * 0.3);
            }
            else if (CarVolume > 1500 && CarVolume <= 1800) {
                DutyPrice = (CarPrice * 0.3 < CarVolume * 1.5) ? (CarVolume * 1.5) : (CarPrice * 0.3);
            }
            else if (CarVolume > 1800 && CarVolume <= 2300) {
                DutyPrice = (CarPrice * 0.3 < CarVolume * 2.15) ? (CarVolume * 2.15) : (CarPrice * 0.3);
            }
            else if (CarVolume > 2300 && CarVolume <= 3000) {
                DutyPrice = (CarPrice * 0.3 < CarVolume * 2.15) ? (CarVolume * 2.15) : (CarPrice * 0.3);
            }
            else if (CarVolume > 3000) {
                DutyPrice = (CarPrice * 0.3 < CarVolume * 2.8) ? (CarVolume * 2.8) : (CarPrice * 0.3);
            }
        }
        else if (CarAge >= 3.0 && CarAge < 5.0) {
            if (CarVolume <= 1000) {
                DutyPrice = (CarPrice * 0.35 < CarVolume * 1.2) ? (CarVolume * 1.2) : (CarPrice * 0.35);
            }
            else if (CarVolume > 1000 && CarVolume <= 1500) {
                DutyPrice = (CarPrice * 0.35 < CarVolume * 1.45) ? (CarVolume * 1.45) : (CarPrice * 0.35);
            }
            else if (CarVolume > 1500 && CarVolume <= 1800) {
                DutyPrice = (CarPrice * 0.35 < CarVolume * 1.5) ? (CarVolume * 1.5) : (CarPrice * 0.35);
            }
            else if (CarVolume > 1800 && CarVolume <= 2300) {
                DutyPrice = (CarPrice * 0.35 < CarVolume * 2.15) ? (CarVolume * 2.15) : (CarPrice * 0.35);
            }
            else if (CarVolume > 2300 && CarVolume <= 3000) {
                DutyPrice = (CarPrice * 0.35 < CarVolume * 2.15) ? (CarVolume * 2.15) : (CarPrice * 0.35);
            }
            else if (CarVolume > 3000) {
                DutyPrice = (CarPrice * 0.35 < CarVolume * 2.8) ? (CarVolume * 2.8) : (CarPrice * 0.35);
            }
        }
        else if (CarAge >= 5.0) {
            if (CarVolume <= 1000) {
                ...
                DutyPrice = CarVolume * 2.9;
            }
            else if (CarVolume > 1800 && CarVolume <= 2300) {
                DutyPrice = CarVolume * 4.0;
            }
            else if (CarVolume > 2300 && CarVolume <= 3000) {
                DutyPrice = CarVolume * 4.0;
            }
            else if (CarVolume > 3000) {
                DutyPrice = CarVolume * 5.8;
            }
        }
    }
        ...
        if (CarAge < 3.0) {
            ...
            else if (CarVolume > 1500 && CarVolume <= 2500) {
                DutyPrice = (CarPrice * 0.3 < CarVolume * 1.9) ? (CarVolume * 1.9) : (CarPrice * 0.3);
            }
            else if (CarVolume > 2500) {
                DutyPrice = (CarPrice * 0.3 < CarVolume * 2.8) ? (CarVolume * 2.8) : (CarPrice * 0.3);
            }
        }
        else if (CarAge >= 3.0 && CarAge < 5.0) {
